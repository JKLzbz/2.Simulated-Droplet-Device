...
class CombinedModel(nn.Module):
    def __init__(self, input_channels, out_channels, num_residual_layers, gru_input_size, gru_hidden_size, gru_num_layers, gru_dropout_rate):
        ...
        # 分类层
        self.classifier = Classifier(input_dim=512, hidden_dim=256, num_classes=4)
...
def main():
    ...
    # 训练模型
    train_loss_history, val_loss_history, train_acc_history, val_acc_history = train_model(model, train_loader, val_loader, criterion, optimizer, 400, 20)
