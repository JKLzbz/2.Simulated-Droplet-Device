...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), 'Res_1DCNN_BiGRU_Attention_Multi_zengqiang_best_model.pth')
...
def main():
    ...
    df.to_excel('Res_1DCNN_BiGRU_Attention_Multi_zengqiang_training_results.xlsx', index=False)
